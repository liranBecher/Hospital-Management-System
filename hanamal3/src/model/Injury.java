...
public class Injury extends MedicalProblem implements IntensiveCareMedicalProblem, Serializable{
	...
	public String toString() {
		return "Injury: "+ super.toString()+"\ncommonRecoveryTime=" + commonRecoveryTime + ", location=" + location 
				 + "]";
	}
	...
	public String shortToString() {
		return "Injury: "+ super.getCode() +", " + super.getName();
	}
